...
namespace Mobiz.Areas.Admin.Controllers
{
    public class SlidesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Image,DisplayOrder,Link,Desciption,CreateDate,CreateBy,ModifiedDate,ModifiedBy,Status")] Slide slide)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Image,DisplayOrder,Link,Desciption,CreateDate,CreateBy,ModifiedDate,ModifiedBy,Status")] Slide slide)
        {
            if (ModelState.IsValid)
            {
